...
//         outputText.setText("System: " + engineName + " Version: " + version);
        ...
        //System.out.print("109");
         ...
         {
            // Check if we're done
            if (!ls.GetArg(solveTerm, 3).equals("more"))
               more = false;
            ...
            do
            {
               ...
               responseTerm = (long) ls.GetArg(actionTerm, 3);
               responseFunctor = ls.GetFunctor(responseTerm);
               responseType = (String) ls.GetArg(responseTerm, 1);
               ...
               if (responseFunctor.equals("ask") && responseType.equals("user"))
               {
                  ...
                  factName = (String) ls.GetArg(responseTerm, 2);
                  ...
                  questionType = question.getProperty("question_type");
                     ...
                     menu = Utils.prologListToProperties(ls, ls.StrToTerm(question.getProperty("choices")), 5000);
               ...
               if (responseFunctor.equals("tell") && responseType.equals("user"))
               {
                  ...
                  String answerType = (String) ls.GetArg(responseTerm, 1);
